    ...
    <div className="flex justify-around h-dvh items-center ">
      ...
      <div className="place-content-center">
        <form
          ...
          className="max-w-2xl ml-5 my-10 p-4 bg-gray-200 rounded-lg shadow-md"
        >
          ...
          <div className="flex justify-end">
            <Link
              ...
              className="w-40 ml-auto py-2 px-4 bg-gray-600 text-white rounded-md hover:bg-blue-700"
            >
              Go to documents
            </Link>
